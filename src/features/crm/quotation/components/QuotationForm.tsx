...
interface Props {
   ...
   *  (Tax & Pricing Architecture layer 4, Task 6) — set by the page-level
   *  onSubmit handler after a failed save, so the reason can render inline
   *  against the specific blocking line instead of only a generic toast. */
