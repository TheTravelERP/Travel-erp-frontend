// src/features/inventory/insuranceProvider/pages/InsuranceProviderListPage.tsx
...
import { getInsuranceProviders } from "../insuranceProvider.api";
import type { InsuranceProviderListItem } from "../insuranceProvider.types";

export default function InsuranceProviderListPage() {
  ...
  const [rows, setRows] = useState<InsuranceProviderListItem[]>([]);
  ...
  return (
    <Box sx={{ p: { xs: 1, md: 1 } }}>
      <ListPageToolbar
        title={isTrash ? t("common.trash") : t("menu.inventory.insurance")}
        breadcrumbs={[
          { label: t("menu.dashboard"), href: "/app/dashboard" },
          { label: isTrash ? t("common.trash") : t("menu.inventory.insurance") },
        ]}
        primaryAction={
          isTrash
            ? {
                key: "view",
                label: t("menu.inventory.insurance"),
                icon: <ListAltIcon />,
                variant: "contained",
            ...
            : {
                ...
                onClick: () => navigate("/app/inventory/insurance/create"),
              }
        }
        overflowActions={[
          {
