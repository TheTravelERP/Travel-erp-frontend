// src/features/inventory/insuranceProvider/pages/InsuranceProviderCreatePage.tsx
...
import { createInsuranceProvider } from "../insuranceProvider.api";
import { usePermission } from "../../../../hooks/usePermission";
import { useSnackbar } from "../../../../components/ui/SnackbarProvider";
import { getErrorMessage } from "../../../../utils/errorMessage";
import { Link as RouterLink } from "react-router-dom";

export default function InsuranceProviderCreatePage() {
  ...
  async function handleCreate(data: InsuranceProviderFormInput) {
    try {
  ...
  return (
    <Box sx={{ p: { xs: 1, md: 1 } }}>
      ...
      <Paper sx={{ p: 3, borderRadius: 2 }}>
        <InsuranceProviderForm onSubmit={handleCreate} />
      </Paper>
    </Box>
  );
}
