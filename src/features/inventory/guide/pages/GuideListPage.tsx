// src/features/inventory/guide/pages/GuideListPage.tsx
...
import { getGuides } from "../guide.api";
...
export default function GuideListPage() {
  ...
  const [rows, setRows] = useState<GuideListItem[]>([]);
  ...
  return (
    <Box sx={{ p: { xs: 1, md: 1 } }}>
      <ListPageToolbar
        title={isTrash ? t("common.trash") : t("menu.inventory.guides")}
        breadcrumbs={[
          { label: t("menu.dashboard"), href: "/app/dashboard" },
          { label: isTrash ? t("common.trash") : t("menu.inventory.guides") },
        ]}
        primaryAction={
          isTrash
            ? {
                key: "view",
                label: t("menu.inventory.guides"),
                icon: <ListAltIcon />,
                variant: "contained",
            ...
            : {
                ...
                onClick: () => navigate("/app/inventory/guides/create"),
              }
        }
        overflowActions={[
          {
