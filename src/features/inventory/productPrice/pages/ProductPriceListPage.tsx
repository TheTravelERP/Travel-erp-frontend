// src/features/inventory/productPrice/pages/ProductPriceListPage.tsx
...
import ProductPriceFilters, { type ProductPriceFilterValues } from "../components/ProductPriceFilters";

import { usePermission } from "../../../../hooks/usePermission";
import { getProductPrices } from "../productPrice.api";
...
export default function ProductPriceListPage() {
  ...
  const appliedFilters: ProductPriceFilterValues = {
    search: searchParams.get("search") || "",
    product_uuid: searchParams.get("product_uuid") || "",
  ...
  const [draftFilters, setDraftFilters] = useState<ProductPriceFilterValues>(appliedFilters);
  ...
  return (
    <Box sx={{ p: { xs: 1, md: 1 } }}>
      <ListPageToolbar
        title={isTrash ? t("common.trash") : t("menu.inventory.product_price_list")}
        breadcrumbs={[
          { label: t("menu.dashboard"), href: "/app/dashboard" },
          { label: isTrash ? t("common.trash") : t("menu.inventory.product_price_list") },
        ]}
        primaryAction={
          isTrash
            ? {
                key: "view",
                label: t("menu.inventory.product_price_list"),
                icon: <ListAltIcon />,
                variant: "contained",
            ...
            : {
                ...
                onClick: () => navigate("/app/inventory/product-price-list/create"),
              }
        }
        secondaryActions={[
          {
