// src/features/inventory/ziyarat/components/ZiyaratFilters.tsx
...
export interface ZiyaratFilterValues {
  search?: string;
  city?: string;
  from_date?: string;
  to_date?: string;
...
interface ZiyaratFiltersProps {
  value: ZiyaratFilterValues;
  onChange: (v: Partial<ZiyaratFilterValues>) => void;
  onApply: () => void;
  onReset: () => void;
}
...
export default function ZiyaratFilters({
  value,
  onChange,
  onApply,
  onReset,
