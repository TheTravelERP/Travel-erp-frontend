// src/features/inventory/transportCompany/pages/TransportCompanyListPage.tsx
...
import TransportCompanyTable from "../components/TransportCompanyTable";

import { usePermission } from "../../../../hooks/usePermission";
import { getTransportCompanies } from "../transportCompany.api";
import type { TransportCompanyListItem } from "../transportCompany.types";

export default function TransportCompanyListPage() {
  ...
  const [rows, setRows] = useState<TransportCompanyListItem[]>([]);
  ...
  return (
    <Box sx={{ p: { xs: 1, md: 1 } }}>
      <ListPageToolbar
        title={isTrash ? t("common.trash") : t("menu.inventory.vendors")}
        breadcrumbs={[
          { label: t("menu.dashboard"), href: "/app/dashboard" },
          { label: isTrash ? t("common.trash") : t("menu.inventory.vendors") },
        ]}
        primaryAction={
          isTrash
            ? {
                key: "view",
                label: t("menu.inventory.vendors"),
                icon: <ListAltIcon />,
                variant: "contained",
            ...
            : {
                ...
                onClick: () => navigate("/app/inventory/vendors/create"),
              }
        }
        overflowActions={[
          {
