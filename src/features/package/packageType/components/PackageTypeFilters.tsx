// src/features/package/packageType/components/PackageTypeFilters.tsx
...
export interface PackageTypeFilterValues {
  search?: string;
  category?: string;
  from_date?: string;
  to_date?: string;
...
interface PackageTypeFiltersProps {
  value: PackageTypeFilterValues;
  onChange: (v: Partial<PackageTypeFilterValues>) => void;
  onApply: () => void;
  onReset: () => void;
}
...
export default function PackageTypeFilters({
  value,
  onChange,
  onApply,
  onReset,
}: PackageTypeFiltersProps) {
      ...
      <Grid container spacing={2}>
        ...
        <Grid size={{ xs: 12, md: 3 }}>
          <DropdownAutocomplete
            ...
            onChange={(val: string | null) => onChange({ category: val || undefined })}
            useForm={false}
            allowAdd={false}
            pagination={false}
          />
