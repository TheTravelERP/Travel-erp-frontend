// src/features/package/packageDetail/components/PackageDetailFilters.tsx
...
export interface PackageDetailFilterValues {
  search?: string;
  is_active?: string;
  from_date?: string;
  to_date?: string;
...
interface PackageDetailFiltersProps {
  value: PackageDetailFilterValues;
  onChange: (v: Partial<PackageDetailFilterValues>) => void;
  onApply: () => void;
  onReset: () => void;
}
...
export default function PackageDetailFilters({
  value,
  onChange,
  onApply,
  onReset,
}: PackageDetailFiltersProps) {
