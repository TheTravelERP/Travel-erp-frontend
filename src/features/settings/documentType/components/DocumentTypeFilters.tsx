// src/features/settings/documentType/components/DocumentTypeFilters.tsx
...
export interface DocumentTypeFilterValues {
  search?: string;
  module_name?: string;
  is_system?: string;
  from_date?: string;
...
interface DocumentTypeFiltersProps {
  ...
  onChange: (v: Partial<DocumentTypeFilterValues>) => void;
  onApply: () => void;
  onReset: () => void;
}
      ...
      <Grid container spacing={2}>
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <TextField
            ...
            onChange={(e) => onChange({ module_name: e.target.value || undefined })}
          />
        </Grid>
