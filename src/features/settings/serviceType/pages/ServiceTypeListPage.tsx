// src/features/settings/serviceType/pages/ServiceTypeListPage.tsx
...
import ServiceTypeFilters, {
  type ServiceTypeFilterValues,
} from "../components/ServiceTypeFilters";

import { usePermission } from "../../../../hooks/usePermission";
import { getServiceTypes } from "../serviceType.api";
...
export default function ServiceTypeListPage() {
  ...
  const appliedFilters: ServiceTypeFilterValues = {
  ...
  const [draftFilters, setDraftFilters] =
    useState<ServiceTypeFilterValues>(appliedFilters);
  ...
  const [rows, setRows] = useState<ServiceTypeListItem[]>([]);
  ...
  return (
    <Box sx={{ p: { xs: 1, md: 1 } }}>
      <ListPageToolbar
        title={isTrash ? t("common.trash") : t("menu.settings.service_type_master")}
        breadcrumbs={[
          { label: t("menu.dashboard"), href: "/app/dashboard" },
          { label: isTrash ? t("common.trash") : t("menu.settings.service_type_master") },
        ]}
        primaryAction={
          isTrash
            ? {
                key: "view",
                label: t("menu.settings.service_type_master"),
                icon: <ListAltIcon />,
                variant: "contained",
            ...
            : {
                ...
                onClick: () => navigate("/app/settings/service-type-master/create"),
              }
        }
        secondaryActions={[
          {
